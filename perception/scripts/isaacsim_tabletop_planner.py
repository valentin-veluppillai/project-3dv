...
# ── Path injection ────────────────────────────────────────────────────────────
_PERCEPTION = Path(__file__).resolve().parent.parent   # curobo-sq/perception/
_CUROBO_SQ  = _PERCEPTION.parent                        # curobo-sq/
...
sys.path.insert(0, str(_CUROBO_SQ / "curobo" / "examples" / "isaac_sim"))
