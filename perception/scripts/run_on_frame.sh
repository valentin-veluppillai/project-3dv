#!/bin/bash
#SBATCH --job-name=sq-on-frame
#SBATCH --account=3dv
#SBATCH --gpus=1
#SBATCH --time=00:15:00
#SBATCH --output=/work/courses/3dv/team15/project-3dv/logs/on_frame_%j.out
...
python3 /work/courses/3dv/team15/curobo-sq/perception/scripts/run_on_frame.py \
  --to_scene_npz data/synth/scene_0.npz \
  --superdec_dir /work/courses/3dv/team15/superdec_concave \
  --ckpt_dir     /work/courses/3dv/team15/superdec_concave/checkpoints/expocc_tt_balanced \
  --out_dir      data/fit_out_synth_0 \
  --exclude_ids  0 \
  --semantic_min 41
