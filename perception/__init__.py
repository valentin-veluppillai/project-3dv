"""
perception — tabletop RGB-D perception for robot manipulation.

Copied from project-3dv/src/project_3dv/perception (live subset only;
dead/unused modules such as grasp_from_sq.py, sq_shape_library.py, the
visualisation/ and simulation/ submodules, and the unused evaluation/
scripts were not carried over — see project-3dv for the full history).
